package android.src.main.java.com.tezcansarizeybek.esc_bluetooth_serial;
...
public class EscBluetoothSerialPlugin implements FlutterPlugin, MethodCallHandler, RequestPermissionsResultListener {
  private static final String TAG = "EscBluetoothSerial";
  private int id = 0;
  private ThreadPool threadPool;
  private static final int REQUEST_COARSE_LOCATION_PERMISSIONS = 1451;
  private static final String NAMESPACE = "esc_bluetooth_serial";
  ...
  public static void registerWith(Registrar registrar) {
    final FlutterBluetoothBasicPlugin instance = new EscBluetoothSerialPlugin(registrar);
  ...
  EscBluetoothSerialPlugin(Registrar r){
    this.registrar = r;
